...
const AddUser: React.FC<AddUserProps> = ({
  ...
  const { createUser, isLoading, error } = useAddUser();
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        setUsernameChanged(e.target.value !== "");
                      }}
                      className={`text-[#2A3136] font-normal rounded-lg flex justify-between items-center w-full cursor-pointer px-4 py-2 h-14 focus:border-blue-900 focus:ring-2 focus:ring-blue-900 outline-none shadow-sm hover:shadow-md transition-shadow duration-300 bg-white border-2 ${
