  ...
  const groups: Group[] = useMemo(
    () => [
      ...
      },
      {
        name: "Full-Timers",
        users: [
          { id: 6, name: "Amra REDACTED" },
          { id: 9, name: "Russell REDACTED" },
          { id: 8, name: "Nana REDACTED" },
          { id: 47, name: "Nigel REDACTED" },
        ],
      },
      {
        name: "Interns",
        users: [
          { id: 45, name: "Felix REDACTED" },
          { id: 44, name: "Marwan REDACTED" },
          { id: 43, name: "Amelie REDACTED" },
          { id: 10, name: "Ryuto REDACTED" },
          { id: 42, name: "Manon REDACTED" },
          { id: 7, name: "Charlotte REDACTED" },
        ],
      },
    ],
    []
