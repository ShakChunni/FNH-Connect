...
interface MeetingsConductedDropdownProps {
...
const meetingsConductedValues = ["Yes", "No"];

const MeetingsConductedDropdown: FC<MeetingsConductedDropdownProps> = ({
  onSelect,
  defaultValue = "",
  style,
  onDropdownToggle,
  ...
  const dropdownItems = useMemo(
    () =>
      meetingsConductedValues.map((value) => (
        <div
          key={value}
    ...
    <>
      <div onClick={(e) => e.stopPropagation()} style={style}>
        ...
        >
          ...
          >
            {selectedValue ? selectedValue : "Select Meeting Conducted Status"}
          </span>
        </button>
      </div>
...
export default MeetingsConductedDropdown;
