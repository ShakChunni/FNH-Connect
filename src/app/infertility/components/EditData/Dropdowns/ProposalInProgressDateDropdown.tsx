...
interface ProposalInProgressDateDropdownProps {
...
const ProposalInProgressDateDropdown: FC<
  ProposalInProgressDateDropdownProps
> = ({
  onSelect,
  defaultValue = null,
  style,
  ...
  const handleDateSelect = useCallback(
    (day: Date) => {
      ...
      if (normalizedDate > todayAtNoon) {
        ...
        onMessage(
          "error",
          "Proposal in progress date cannot be older than prospect date."
        );
        return;
      } else if (
        meetingDate &&
        ...
        onMessage(
          "error",
          "Proposal in progress date cannot be older than meeting date."
        );
        return;
      }
    ...
    [onSelect, closeDropdown, prospectDate, meetingDate, onMessage]
  );
      ...
      >
        ...
        >
          {selectedDate
            ...
            : "Select Proposal In Progress Date"}
        </span>
      </button>
...
export default ProposalInProgressDateDropdown;
