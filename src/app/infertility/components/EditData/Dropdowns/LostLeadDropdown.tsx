...
interface LostLeadDropdownProps {
...
const lostLeadValues = ["Yes", "No"];

const LostLeadDropdown: FC<LostLeadDropdownProps> = ({
  onSelect,
  defaultValue = "No",
  style,
  onDropdownToggle,
    ...
    <>
      <div onClick={(e) => e.stopPropagation()} style={style}>
        ...
        >
          ...
          >
            {selectedValue ? selectedValue : "Select Lost Lead"}
          </span>
        </button>
      </div>
...
export default LostLeadDropdown;
