  ...
  return (
    <DropdownMenu.Root open={isOpen} onOpenChange={handleOpenChange}>
      <DropdownMenu.Trigger>
        ...
        >
          <span ref={spanRef}>Filter Quotation Signed Date: {value}</span>
          <span ref={iconRef}>
...
export default QuotationSignedDate;
