...
interface HospitalTypeDropdownProps {
  value: string;
...
const HospitalTypeDropdown: React.FC<HospitalTypeDropdownProps> = ({
  value,
  onSelect,
  options,
  disabled = false,
  ...
  // identical logic as BloodGroupDropdown
...
export default HospitalTypeDropdown;
