...
interface ShiftTableProps {
  ...
  isLoading: boolean;
  onSelectShift: (shift: CashTrackingShift) => void;
}
        ...
        <table className="w-full text-left border-collapse min-w-[800px] lg:min-w-full">
          <thead>
            <tr className="bg-fnh-navy text-white">
              <th className="px-4 py-3 sm:px-6 sm:py-4 text-[10px] sm:text-xs font-bold uppercase tracking-wider sm:sticky sm:left-0 sm:z-20 bg-fnh-navy w-[200px] min-w-[200px] sm:shadow-[2px_0_5px_rgba(0,0,0,0.1)]">
                Staff Details
              </th>
              ...
              <th className="px-4 py-3 sm:px-6 sm:py-4 text-[10px] sm:text-xs font-bold uppercase tracking-wider text-center whitespace-nowrap">
                Status
              </th>
          ...
          <tbody className="divide-y divide-gray-100">
            {shifts.map((shift) => (
              ...
              >
                <td className="px-4 py-3 sm:px-6 sm:py-4 sm:sticky sm:left-0 sm:z-10 bg-white group-hover:bg-gray-50 transition-colors sm:shadow-[2px_0_5px_rgba(0,0,0,0.02)] w-[200px] min-w-[200px]">
