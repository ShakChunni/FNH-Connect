      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="flex-1 p-4 sm:p-6 flex flex-col">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 sm:gap-2.5">
            ...
            {/* Ordered By moved here to fill gap on the left */}
            {patient.orderedBy && (
              <div className="sm:col-span-2 mt-1">
                <div className="bg-linear-to-r from-teal-50/80 to-cyan-50/80 rounded-xl p-2.5 sm:p-3 border border-teal-100/50 flex items-center justify-between group hover:border-teal-200 transition-colors">
                  <div className="flex flex-col">
                    <span className="text-[8px] sm:text-[9px] font-bold text-teal-600 uppercase tracking-widest mb-0.5">
                      Ordered By Physician
                    </span>
                    <span className="text-xs sm:text-sm font-bold text-teal-900 leading-none">
                      {patient.orderedBy}
                    </span>
                  </div>
