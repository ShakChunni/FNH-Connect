...
export type InfertilityTestStatus = "Completed" | "Pending" | "All";
...
interface FilterActions {
  ...
  setStatus: (status: InfertilityTestStatus) => void;
...
export const useInfertilityTestFilterStore = create<FilterStore>((set, get) => ({
  // Initial state
...
export const useInfertilityTestFilterPanelState = () =>
  useInfertilityTestFilterStore((state) => state.panel);

export const useInfertilityTestFilterValues = () =>
  useInfertilityTestFilterStore((state) => state.filters);

export const useInfertilityTestReportState = () =>
  useInfertilityTestFilterStore((state) => state.report);

export const useInfertilityTestFilterActions = () =>
...
export const useInfertilityTestReportActions = () =>
  useInfertilityTestFilterStore(
    useShallow((state) => ({
