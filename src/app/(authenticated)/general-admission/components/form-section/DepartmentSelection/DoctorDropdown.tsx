...
interface DoctorDropdownProps {
  value: number | null;
  onSelect: (value: number | null, doctor?: Doctor) => void;
  disabled?: boolean;
...
const DoctorDropdown: React.FC<DoctorDropdownProps> = ({
  ...
  const handleSelect = useCallback(
    (doctorId: number) => {
      if (disabled) return;
      const doc = allStaff.find((d) => d.id === doctorId);
      onSelect(doctorId, doc);
      closeDropdown();
    },
    [onSelect, disabled, closeDropdown, allStaff]
  );
            ...
            <div className="sticky top-0 bg-gray-50 z-10 p-3 border-b border-gray-200">
              <div className="relative">
                ...
                <input
                  ...
                  className="doctor-search-input-admission w-full pl-10 pr-4 py-2 rounded-lg border border-gray-200 focus:border-blue-950 focus:ring-1 focus:ring-blue-200 focus:outline-none text-sm bg-white transition-all duration-150 placeholder:text-gray-400"
                />
              </div>
