...
const PathologyManagement = React.memo(() => {
  ...
  const tableData: PathologyPatientData[] = useMemo(() => {
    return pathologyPatients.map((patient) => ({
      ...
      hospitalAddress: patient.hospital?.address || null,
      hospitalPhone: patient.hospital?.phoneNumber || null,
      hospitalEmail: patient.hospital?.email || null,
      hospitalWebsite: patient.hospital?.website || null,
      hospitalType: patient.hospital?.type || null,
