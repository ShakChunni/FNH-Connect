      ...
      <div className="p-6 flex flex-col sm:flex-row gap-6 items-center sm:items-start text-center sm:text-left">
        ...
        <div className="flex-1 space-y-2 w-full">
          <div>
            ...
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-x-4 gap-y-2 text-sm text-gray-600 mt-2 font-medium">
                  ...
                  {patient.patientAge ??
                    (patient.patientDOB
                      ? new Date().getFullYear() -
                        new Date(patient.patientDOB).getFullYear()
                      : "N/A")}{" "}
                  Years
                </span>
              ...
              {patient.bloodGroup && (
                <span className="flex items-center gap-1.5 bg-red-50 px-2.5 py-1 rounded-md border border-red-100 text-red-600 font-bold">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm mt-3 pt-3 border-t border-gray-100">
