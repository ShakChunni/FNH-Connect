...
import { FileText, BarChart3, Receipt, FileSpreadsheet } from "lucide-react";
    ...
    <>
      ...
      >
        <div className="py-2">
          ...
          <button
            onClick={() => handleAction(onGenerateFinancial)}
            className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 
              hover:bg-slate-100 transition-colors cursor-pointer"
          >
            ...
            <div className="text-left">
              ...
              <div className="text-xs text-gray-400">Revenue & payments</div>
            </div>
          </button>
