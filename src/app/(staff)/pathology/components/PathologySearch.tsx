...
// Department options for pathology page
 ...
 * Wraps the global SearchBar with pathology-specific logic
  ...
  return (
    ...
    >
      <SearchBar
        ...
        placeholder="Search by patient name, test number, or mobile number..."
        showDateFilter={true}
