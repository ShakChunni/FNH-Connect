...
const EditDataInfertility: React.FC<EditDataProps> = ({
  ...
  const { initializeFormForEdit, resetFormState } = useInfertilityActions();
  ...
  const handleSubmit = useCallback(() => {
    ...
    // Destructure to separate the optional id from the rest of the payload
    const { id: _unusedId, ...payloadWithoutId } = payload;

    // Add the infertility record ID for the edit operation
    editPatient({
