  ...
  return (
    <div className="relative mt-auto" ref={profileRef}>
      ...
      >
        ...
        >
          <div className="flex h-12 w-12 min-w-[3rem] items-center justify-center rounded-xl bg-white/15 text-base font-semibold text-white flex-shrink-0">
            {initials}
          </div>
          {isExpanded && (
            <>
              ...
              <button
                type="button"
                className="ml-auto inline-flex h-8 w-8 flex-shrink-0 items-center justify-center text-white/40 transition-all duration-200 hover:text-white hover:cursor-pointer"
              ...
              <>
                ...
                >
                  ...
                  <div className="flex items-center gap-1 leading-tight min-w-0">
                    ...
                    <span className="text-[9px] font-semibold uppercase tracking-[0.25em] text-[#FEDD00] whitespace-nowrap">
                      Employee
                    </span>
                  </div>
                </Link>
                <button
                  ...
                  className="inline-flex h-6 w-6 items-center justify-center text-white/40 transition-all duration-200 hover:text-white hover:cursor-pointer flex-shrink-0"
              ...
              {navigationItems.map((item) => {
                ...
                return (
                  <li key={item.href}>
                    ...
                    >
                      <span
                        className={`flex h-9 w-9 min-w-[2.25rem] flex-shrink-0 items-center justify-center rounded-xl transition-all duration-200 ${
                          isActive
