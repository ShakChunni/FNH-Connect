...
import PathologyTestsDropdown from "./Fields/PathologyTestsDropdown";
import OrderingDoctorDropdown from "./PathologyInformation/OrderingDoctorDropdown";
...
const PathologyInformation: React.FC = () => {
  ...
  const initialPayment = pathologyInfo.initialPayment || 0;
  ...
  useEffect(() => {
    ...
    if (
      ...
      pathologyInfo.paidAmount !== initialPayment ||
  ...
  // Handle initial payment change - allow empty string for better UX
  const handleInitialPaymentChange = (
    ...
    setPathologyInfo({
      ...pathologyInfo,
      initialPayment: val === "" ? 0 : Number(val),
    });
  };
  ...
  return (
    <div id="pathology" className="mt-2 sm:mt-0 mb-6 sm:mb-8 md:mb-10">
      ...
      <div className="mb-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">
            Select the doctor who ordered/prescribed the test
          </p>
        </div>
      </div>
      ...
      {/* Financial Information - Reordered Layout */}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                type="number"
                className={`${inputClassName(
                  pathologyInfo.initialPayment,
                  false
                )} pl-10`}
                value={pathologyInfo.initialPayment || ""}
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`${inputClassName(
                  ...
                  pathologyInfo.dueAmount > 0 ? "text-red-600" : "text-gray-600"
                }`}
