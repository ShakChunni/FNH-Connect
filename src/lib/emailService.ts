...
export const sendDeleteNotification = async (
  ...
  const idPrefix = log.source_table.toUpperCase() === "MI" ? "REDACTED" : "MV";
  const organizationPrefix =
    log.source_table.toUpperCase() === "MI" ? "REDACTED" : "REDACTED";
  ...
  <body>
    <div class="grey-container">
      <div class="header">
        <img src="https://sales.REDACTED.my/REDACTED_ASSET.png" alt="REDACTED" />
      </div>
      <div class="container">
        <div class="alert">
          <img src="https://sales.REDACTED.my/danger.png" alt="Warning" />
        ...
        <div class="button">
          <a href="https://sales.REDACTED.my/admin/activity-logs" target="_blank">
            Open Activity Log
          </a>
        </div>
      </div>
  ...
  try {
    await client.sendEmail({
      From: "Sales Dashboard <redacted@example.invalid>",
      To: "redacted@example.invalid, redacted@example.invalid, redacted@example.invalid",
